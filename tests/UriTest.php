...
class UriTest extends TestCase
{
    ...
    {
        $this->assertEquals('https', $this->uriFactory()
            ->getScheme());
    }
    ...
    {
        $this->assertEquals('josh:sekrit@example.com', $this->uriFactory()
            ->getAuthority());
    }
    ...
    {
        $this->assertEquals('example.com', $this->uriFactory()
            ->getHost());
    }
    ...
    {
        $this->assertEquals('/foo/bar', $this->uriFactory()
            ->getPath());
    }
    ...
    {
        $this->assertEquals('abc=123', $this->uriFactory()
            ->getQuery());
    }
    ...
    {
        $this->assertEquals('section3', $this->uriFactory()
            ->getFragment());
    }
    ...
    public function testCreateFromStringWithInvalidType()
    {
        Uri::createFromString([
            'https://example.com:8080/foo/bar?abc=123'
        ]);
    }
    ...
    {
        $uri = Uri::createFromEnvironment(Environment::mock([
            'SCRIPT_NAME' => '/foo/index.php',
