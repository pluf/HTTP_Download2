...
class RequestTest extends TestCase
{
    ...
    {
        $this->assertEquals('GET', $this->requestFactory()
            ->getMethod());
    }
    ...
    {
        $this->assertEquals('/foo/bar?abc=123', $this->requestFactory()
            ->getRequestTarget());
    }
    ...
    public function testGetCookieParams()
    {
        ...
        $this->assertEquals($shouldBe, $this->requestFactory()
            ->getCookieParams());
    }
    ...
    {
        $request = $this->requestFactory();
        $clone = $request->withCookieParams([
            'type' => 'framework'
        ]);
    ...
    {
        $files = [
            new UploadedFile('foo.txt'),
            new UploadedFile('bar.txt')
        ];
    ...
    {
        $clone = $this->requestFactory()->withParsedBody([
            'xyz' => '123'
        ]);
