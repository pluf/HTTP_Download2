...
class ResponseTest extends TestCase
{
    ...
    public function testConstructorWithDefaultArgs()
    {
        ...
        $this->assertAttributeInstanceOf('\Pluf\Http\Headers', 'headers', $response);
    ...
    {
        $output = 'HTTP/1.1 404 Not Found' . Response::EOL . 'X-Foo: Bar' . Response::EOL . Response::EOL . 'Where am I?';
